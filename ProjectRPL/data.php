        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto pt-2 pt-lg-0 font-base">
                    ...
                    <li class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link" aria-current="page" href="homeadmin.php">Home</a></li>
                    <li class="nav-item px-2" data-anchor="data-anchor"><a class="nav-link fw-medium active" href="data.php">Data</a></li>
    ...
    <table class="table container table-stripped mt-3" style="font-size: 12px;">
        ...
        <tbody class="table">
            <tr>
                ...
                <td>
                    <a class="btn btn-danger py-2 px-3" style="font-size: 10px;" role="button" href="edit.php?id=<?php echo $data['id'];?>">Edit</a>
                    <a class="btn btn-secondary py-2 px-3" style="font-size: 10px;" role="button" href="delete.php?id=<?php echo $data['id'];?>">Delete</a>
                </td>
            </tr>
        </tbody>
        <?php 
